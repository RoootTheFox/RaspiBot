...
public class GlobalChatUnmodCommand implements Command {
    ...
    public void run(Message msg, String[] args, Guild guild) {
        ...
        String SQL_QUERY2 = "INSERT INTO globalchat_userdata SET `userid` = '"+target.getId()+"', `username` = \""+target.getAsTag()+"\", isMod = false ON DUPLICATE KEY UPDATE `userid` = '"+target.getId()+"', `username` = \""+target.getAsTag()+"\", isMod = false";
        try {
    ...
    @Override
    public String getName() { return "gcunmod"; }
